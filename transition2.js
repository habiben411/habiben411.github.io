...
window.addEventListener('DOMContentLoaded', (event) => {
    var gallerianDiv = document.getElementById("gallerian");
    divClone = gallerianDiv.cloneNode(true); // Clone the div
});

// Later, when you want to reset the div
function resetDiv() {
    var gallerianDiv = document.getElementById("gallerian");
 
    // Replace the current div with the clone
    gallerianDiv.parentNode.replaceChild(divClone, gallerianDiv);
}
...
function startImageTransition() {
    ...
    let images = document.getElementsByClassName("imageGallery2");
    ...
    let gen_id = setInterval(changeImage, 1000);
